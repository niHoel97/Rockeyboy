...
@Composable
fun RocketLaunchAnimation(launchRocket: Boolean) {
    ...
    Box(
        ...
        Image(
            ...
            modifier = Modifier.align(Alignment.BottomCenter).graphicsLayer(rotationZ = 315f) // Plasser raketten nederst på skjermen,
        )
    }
}
